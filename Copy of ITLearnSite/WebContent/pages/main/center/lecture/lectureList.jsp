...
<div class="custom-breadcrumns border-bottom">
	<div class="container">
		<a href="${path}/index.do">Home</a> <span class="mx-3 icon-keyboard_arrow_right"></span> <span class="current">강의</span>
	</div>
</div>
									...
									<div class="course-1-content pb-4">
										...
										<p>
											...
											<a
												...
												class="btn btn-primary rounded-0 px-4">장바구니</a> <a style="margin: 5px;"
												href="${path }/pages/main/center/lecture/temp/${lecture.lec_spofile }" class="btn btn-primary rounded-0 px-4" data-fancybox="">맛보기</a>
