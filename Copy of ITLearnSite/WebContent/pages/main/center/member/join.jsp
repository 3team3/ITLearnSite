...
<body>
	<div>
		<form onsubmit="return submitter();" action="insertMember.do" method="post">
			...
			<h5>패스워드</h5>
			<input type="password" name="pw1" id="pw1" onkeyup="pwdRegChk();"> <br>
			<h5>패스워드 확인</h5>
			<input type="password" name="pw2" id="pw2" onkeyup="pwdEqualChk();"> <br>
			<h5>이름</h5>
			<input type="text" name="name" id="name" onkeyup="nameChk();"> <br>
			<h5>성별</h5>
			<br> <input type="radio" name="gender" id="gender1" value="1" onchange="selectGenderChk();">남 &nbsp; 
			...
			<h5>휴대전화</h5>
			<input type="text" name="phonenumber" id="phonenumber" onkeyup="phoneChk();"> <br>
			<h5>주소</h5>
			<input type="text" name="address" id="address" placeholder="우편번호" readonly="readonly" onblur="addressChk();"> <br> 
