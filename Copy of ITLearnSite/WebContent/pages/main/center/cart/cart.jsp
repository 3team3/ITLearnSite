...
<script type="text/javascript">
	...
	function edit(cart_num, pro_cnt) {
		/*요소갯수 구하기*/
		//alert("cart_num" + cart_num + "pro_cnt" + pro_cnt);
		location.href = "cartEdit.cart?cart_num=" + cart_num + "&pro_cnt="
				+ pro_cnt;
	}
</script>
								...
								<c:if test="${cartlist.pro_sort == '도서'}">
									...
									<td class="count" style="width: 250px;">
										<div class="quantity">
											...
											<input type="text" name="pro_cnt${i}" value="${cartlist.pro_cnt}" class="num">
											<%-- 										<c:out value="${i}"></c:out> --%>
											<%-- 										<c:out value="${cartlist.pro_cnt}"></c:out> --%>
